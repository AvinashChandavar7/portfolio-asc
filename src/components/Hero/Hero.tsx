    ...
    <Bounded ref={component}>
      <div className="grid min-h-[70vh] grid-cols-1 items-center md:grid-cols-2">
        <div className="col-start-1 md:row-start-1" data-speed=".2">
          ...
          <span className="job-title block bg-gradient-to-tr from-red-500 via-blue-500 to-green-500 bg-clip-text text-2xl font-bold uppercase tracking-[.2em] text-transparent opacity-0 md:text-4xl">
            {data.tag_line}
          </span>
        </div>
